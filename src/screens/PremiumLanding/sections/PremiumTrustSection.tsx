...
export const PremiumTrustSection = (): JSX.Element => {
  ...
  const content = premiumLandingContent[language].standards;
  const metrics = [
    {
      Icon: BookOpen
    },
      ...
      <div className="mx-auto max-w-6xl px-6 py-32">
          ...
          <div>
            ...
            >
              ...
              <h2 className="mt-6 font-montserrat text-4xl font-black leading-tight tracking-tighter text-stone-900 md:text-5xl">
                {content.title} <br />
                <span className="text-stone-500 font-light italic">{content.subtitle}</span>
              </h2>
                ...
                >
                  ...
                  <div className="flex flex-col h-full">
                    ...
                    <p className="mt-2 font-montserrat text-[10px] font-bold uppercase tracking-[0.2em] text-stone-400">
                      {content.fieldLabel} {metric.category}
                    </p>
          ...
          >
            ...
            <div className="absolute bottom-10 -left-10 z-20 bg-white/90 backdrop-blur-md border border-stone-200 p-6 rounded-2xl shadow-xl max-w-[200px]">
              <div className="flex items-center gap-3 mb-2">
                ...
                <span className="text-[10px] font-bold uppercase tracking-widest text-stone-500">{content.badgeSmall}</span>
              </div>
              <p className="text-xs font-montserrat font-bold text-stone-800">{content.badgeText}</p>
            </div>
          </motion.div>
        </div>
        ...
        >
          ...
          <div className="relative z-10 mt-10 flex items-center gap-6">
            ...
            <span className="font-montserrat text-xs font-bold uppercase tracking-[0.4em] text-stone-400">{content.bottomLabel}</span>
            <div className="h-px w-8 bg-blue-500/50" />
          </div>
        </motion.div>
      </div>
